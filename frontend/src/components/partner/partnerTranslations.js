...
export const translations = {
  ...
  sq: {
    ...
    scanVoucher: 'Skano kuponin',
    startCamera: 'Fillo kamerën',
    manualEntry: 'Vendosje manuale',
    voucherCode: 'Kodi i kuponit',
    validVoucher: 'Kupon i vlefshëm',
    invalidVoucher: 'Kupon i pavlefshëm',
    redeemNow: 'Përdore tani',
    value: 'Vlera',
    amount: 'Shuma',
    // New translations for error messages
    cameraAccessError: 'Qasja në kamerë nuk është e mundur. Ju lutem vendosni kodin QR manualisht.',
    customerFound: 'Klienti u gjet',
    invalidQRCode: 'Kod QR i pavlefshëm',
    enterValidAmount: 'Ju lutem vendosni një shumë të vlefshme',
    customerInsufficientBalance: 'Klienti nuk ka bilanc të mjaftueshëm',
    paymentSuccess: 'Pagesa e suksesshme',
    paymentFailed: 'Pagesa dështoi',
    // Budget translations
    budget: 'Buxheti',
    balance: 'Bilanci',
    paidCredit: 'Kredit i paguar',
    freeCredit: 'Kredit falas',
    topUp: 'Ngarko',
    contactAdmin: 'Ju lutem kontaktoni administratorin për kredit falas ose ngarkoni bilanc.',
    voucherRedemptions: 'Përdorimet e kuponëve',
    totalEarnings: 'Fitimet totale',
    // Staff management
    staffManagement: 'Menaxhimi i stafit',
    staffDescription: 'Menaxhoni stafin tuaj dhe të drejtat e tyre të aksesit.',
    adminFullAccess: 'Akses i plotë në statistika, pagesa dhe cilësime',
    counterLimitedAccess: 'Vetëm skaneri & pagesat',
    createStaffMember: 'Krijo anëtar stafi',
    editStaff: 'Redakto stafin',
    ...
    commissionPaid: 'Komisioni i paguar',
    paidOut: 'I paguar',
    voucherStatus: 'Statusi i kuponëve',
    topVouchers: 'Kuponët kryesorë',
    revenue: 'Të ardhurat',
    redemptionsChart: 'Përdorimet (30 ditët e fundit)',
    // Verification
    verified: 'I verifikuar',
    inReview: 'Nën shqyrtim',
    notVerified: 'I pa verifikuar',
    uploadDocument: 'Ngarko dokument',
    documentType: 'Lloji i dokumentit',
    businessRegistration: 'Regjistrimi i biznesit',
    taxCertificate: 'Certifikata e tatimit',
    idDocument: 'Dokumenti i identifikimit',
    bankStatement: 'Deklarata bankare',
    noDocuments: 'Nuk ka dokumente të ngarkuara ende',
    // Referrals
    referral: 'Refero partnerë',
    yourReferralCode: 'Kodi juaj i referimit',
    referralBonus: 'Fitoni €10 për çdo partner të referuar!',
    totalReferrals: 'Referimet',
    successful: 'E suksesshme',
    pendingBonus: 'Bonus në pritje',
    totalEarned: 'Fituar',
    recentReferrals: 'Referimet e fundit',
    copied: 'Kopjuar!',
    qrCodes: 'Kodet QR',
    download: 'Shkarko',
