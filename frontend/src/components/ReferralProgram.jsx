...
const translations = {
  de: {
    ...
    step2: 'Dein Freund meldet sich an und zahlt min. €5 ein',
    step3: 'Du bekommst €10 Guthaben, dein Freund 5 Gratis-Gebote!',
    ...
    codeUsed: 'Code erfolgreich eingelöst! Nach deiner ersten Einzahlung (min. €5) erhältst du 5 Gratis-Gebote.',
    shareText: 'Melde dich bei BidBlitz an mit meinem Code {code}! Zahle €5 ein und wir beide bekommen Bonus!',
  ...
  en: {
    ...
    step2: 'Your friend signs up and deposits min. €5',
    step3: 'You get €10 credit, your friend gets 5 free bids!',
