    ...
    return (
      <div className="min-h-screen pt-24 pb-12 px-4 flex items-center justify-center">
        <div className="glass-card p-8 rounded-xl text-center max-w-md">
          ...
          <h2 className="text-xl font-bold text-white mb-4">Wunschliste</h2>
          <p className="text-[#94A3B8] mb-6">Melden Sie sich an, um Ihre Wunschliste zu sehen.</p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Button 
            ...
            className="bg-[#FF4D4D] hover:bg-[#EF4444] text-white"
        ...
        {wishlist.length === 0 ? (
          <div className="glass-card p-12 rounded-xl text-center">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Deine Wunschliste ist leer</h3>
                ...
                <div className="flex items-center gap-4">
                  {item.product ? (
                    ...
                    <>
                      ...
                      <div>
                        <h3 className="font-bold text-white">Kategorie: {item.category}</h3>
        ...
        {showAddModal && (
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
            <div className="bg-[#181824] rounded-2xl max-w-lg w-full max-h-[80vh] overflow-hidden">
              <div className="p-6 border-b border-white/10 flex items-center justify-between">
                <h2 className="text-xl font-bold text-white">Zur Wunschliste hinzufügen</h2>
                <Button 
                  variant="ghost" 
                  size="sm" 
              ...
              <div className="p-6 space-y-6">
                {/* Category Selection */}
                <div>
                  <h3 className="font-bold text-white mb-3">Kategorie beobachten</h3>
                ...
                {/* Product Search */}
                <div>
                  <h3 className="font-bold text-white mb-3">Produkt suchen</h3>
                  <div className="relative mb-4">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-[#0F0F16] border border-white/10 rounded-lg text-white placeholder:text-[#475569] focus:border-[#FF4D4D] focus:outline-none"
                    />
                  </div>
                  ...
                  <div className="max-h-64 overflow-y-auto space-y-2">
                    {filteredProducts.slice(0, 10).map((product) => (
                      <div
                        ...
                        className="flex items-center gap-3 p-3 rounded-lg bg-[#0F0F16] hover:bg-white/5 cursor-pointer transition-colors"
                      >
                        <img 
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-[#94A3B8] text-xs">{product.category}</p>
                        </div>
                        <Plus className="w-5 h-5 text-[#FF4D4D]" />
                      </div>
                    ))}
                    {filteredProducts.length === 0 && (
                      <p className="text-[#94A3B8] text-center py-4">Keine Produkte gefunden</p>
                    )}
                  </div>
                </div>
              </div>
