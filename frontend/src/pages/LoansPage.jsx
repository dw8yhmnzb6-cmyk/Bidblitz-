...
const t = {
  de: { title: 'Meine Kredite', subtitle: 'Mikrokredite verwalten', apply: 'Beantragen', applyTitle: 'Kredit beantragen', applySubtitle: 'Schnelle Mikrokredite fuer BidBlitz-Nutzer', amount: 'Betrag', term: 'Laufzeit', days: 'Tage', purpose: 'Verwendungszweck', summary: 'Zusammenfassung', loanAmount: 'Kreditbetrag', interest: 'Zinsen (ca. 15% p.a.)', totalDue: 'Gesamt zurueckzuzahlen', kycNotice: 'KYC-Verifizierung erforderlich. Ihr Antrag wird innerhalb von 5 Minuten geprueft.', submitBtn: 'Kredit beantragen', back: 'Zurueck', noLoans: 'Noch keine Kredite', noLoansDesc: 'Beantragen Sie Ihren ersten Mikrokredit', repayFull: 'Vollstaendig zurueckzahlen', reason: 'Grund', infoBanner: 'Schnelle Mikrokredite', infoDesc: '50-5.000 EUR | 7-365 Tage | Ab 15% p.a.', payout: 'Auszahlung', payoutWallet: 'Auf BidBlitz Wallet', payoutBank: 'Auf Bankkonto (SEPA)', payoutInstant: 'Sofort-Auszahlung', payoutMethod: 'Auszahlungsmethode' },
  en: { title: 'My Loans', subtitle: 'Manage micro-loans', apply: 'Apply', applyTitle: 'Apply for a loan', applySubtitle: 'Quick micro-loans for BidBlitz users', amount: 'Amount', term: 'Term', days: 'Days', purpose: 'Purpose', summary: 'Summary', loanAmount: 'Loan amount', interest: 'Interest (approx. 15% p.a.)', totalDue: 'Total to repay', kycNotice: 'KYC verification required. Your application will be reviewed within 5 minutes.', submitBtn: 'Apply for loan', back: 'Back', noLoans: 'No loans yet', noLoansDesc: 'Apply for your first micro-loan', repayFull: 'Repay in full', reason: 'Reason', infoBanner: 'Quick micro-loans', infoDesc: '50-5,000 EUR | 7-365 days | From 15% p.a.', payout: 'Payout', payoutWallet: 'To BidBlitz Wallet', payoutBank: 'To bank account (SEPA)', payoutInstant: 'Instant payout', payoutMethod: 'Payout method' },
  sq: { title: 'Kreditë e mia', subtitle: 'Menaxho mikrokreditë', apply: 'Apliko', applyTitle: 'Apliko për kredi', applySubtitle: 'Mikrokreditë të shpejta për përdoruesit e BidBlitz', amount: 'Shuma', term: 'Afati', days: 'Ditë', purpose: 'Qëllimi', summary: 'Përmbledhje', loanAmount: 'Shuma e kredisë', interest: 'Interesi (rreth 15% p.a.)', totalDue: 'Totali për t\'u kthyer', kycNotice: 'Verifikimi KYC i nevojshëm. Aplikimi juaj do të shqyrtohet brenda 5 minutave.', submitBtn: 'Apliko për kredi', back: 'Kthehu', noLoans: 'Ende pa kredi', noLoansDesc: 'Apliko për kredinë tuaj të parë', repayFull: 'Kthe plotësisht', reason: 'Arsyeja', infoBanner: 'Mikrokreditë e shpejta', infoDesc: '50-5,000 EUR | 7-365 ditë | Nga 15% p.a.', payout: 'Pagesa', payoutWallet: 'Në BidBlitz Wallet', payoutBank: 'Në llogari bankare (SEPA)', payoutInstant: 'Pagesë e menjëhershme', payoutMethod: 'Mënyra e pagesës' },
  tr: { title: 'Kredilerim', subtitle: 'Mikro kredileri yönet', apply: 'Başvur', applyTitle: 'Kredi başvurusu', applySubtitle: 'BidBlitz kullanıcıları için hızlı mikro krediler', amount: 'Tutar', term: 'Vade', days: 'Gün', purpose: 'Amaç', summary: 'Özet', loanAmount: 'Kredi tutarı', interest: 'Faiz (yakl. %15 yıllık)', totalDue: 'Toplam geri ödeme', kycNotice: 'KYC doğrulaması gerekli. Başvurunuz 5 dakika içinde incelenecektir.', submitBtn: 'Kredi başvurusu yap', back: 'Geri', noLoans: 'Henüz kredi yok', noLoansDesc: 'İlk mikro krediniz için başvurun', repayFull: 'Tam geri öde', reason: 'Sebep', infoBanner: 'Hızlı mikro krediler', infoDesc: '50-5.000 EUR | 7-365 gün | %15 yıllık faizden', payout: 'Ödeme', payoutWallet: 'BidBlitz Cüzdanına', payoutBank: 'Banka hesabına (SEPA)', payoutInstant: 'Anında ödeme', payoutMethod: 'Ödeme yöntemi' },
  fr: { title: 'Mes crédits', subtitle: 'Gérer les micro-crédits', apply: 'Demander', applyTitle: 'Demander un crédit', applySubtitle: 'Micro-crédits rapides pour les utilisateurs BidBlitz', amount: 'Montant', term: 'Durée', days: 'Jours', purpose: 'Objet', summary: 'Résumé', loanAmount: 'Montant du crédit', interest: 'Intérêts (env. 15% p.a.)', totalDue: 'Total à rembourser', kycNotice: 'Vérification KYC requise. Votre demande sera examinée dans les 5 minutes.', submitBtn: 'Demander le crédit', back: 'Retour', noLoans: 'Pas encore de crédits', noLoansDesc: 'Demandez votre premier micro-crédit', repayFull: 'Rembourser intégralement', reason: 'Raison', infoBanner: 'Micro-crédits rapides', infoDesc: '50-5.000 EUR | 7-365 jours | À partir de 15% p.a.', payout: 'Versement', payoutWallet: 'Sur BidBlitz Wallet', payoutBank: 'Sur compte bancaire (SEPA)', payoutInstant: 'Versement instantané', payoutMethod: 'Mode de versement' },
};
