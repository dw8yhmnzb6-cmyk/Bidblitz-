...
const translations = {
  ...
  ar: {
    ...
    subtitle: 'اكتشف جميع مزايا BidBlitz',
  ...
  tr: {
    ...
    subtitle: 'Tüm BidBlitz avantajlarını keşfet',
    ...
    giftsDesc: 'BidBlitz teklifleri hediye et',
    alarm: 'Teklif Alarmı',
  ...
  fr: {
    ...
    subtitle: 'Découvrez tous les avantages BidBlitz',
    ...
    giftsDesc: 'Offrez des enchères BidBlitz',
